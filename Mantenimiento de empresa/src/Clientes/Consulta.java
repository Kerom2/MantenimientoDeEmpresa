...
public class Consulta extends javax.swing.JFrame {
    ...
    public Consulta() {
        initComponents();
        co.Bloquear_objetos_consultar(jTextField1, jTextField4, jTextField5, 
                jTextField6, jTextField7, jTextField8, jTextField9, jTextField10,
                jTextField11, jTextField12, jTextField13);
        md.CargarComboClientes(jComboBox2);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Consulta de Contactos");
        ...
        jLabel13.setText("Ya registrados:");
...
//BOTON LIMPIAR
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        co.Limpiar_Componentes_consultar(jTextField1, jTextField4, jTextField5, 
                jTextField6, jTextField7, jTextField8, jTextField9, jTextField10,
                jTextField11, jTextField12, jTextField13);
        ...
        if (jTextField1.getText().equals("")){
            ...
            if (md.buscar_id(jTextField1.getText())==1){
                ...
                for (int i=0; i<cum.length(); i++) {
                    ...
                    jTextField7.setText(vdia); jTextField8.setText(vmes); jTextField9.setText(vanio);

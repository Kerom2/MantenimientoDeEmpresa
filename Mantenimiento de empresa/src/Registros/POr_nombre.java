...
//mostrar
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       //verificamos que el texto este lleno
        if (jTextField1.getText().equals("")) {
            ...
            mr.cargartablaclientespornombre(jTable1, jTextField1.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(POr_nombre.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new POr_nombre().setVisible(true);
            }
        });
    }

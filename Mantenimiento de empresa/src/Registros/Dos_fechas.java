...
public class Dos_fechas extends javax.swing.JFrame {
    //instanciamos modelo datos
    MODELO_REPORTES mr = new MODELO_REPORTES();
    //intanciamos validaiones
    ...
    private void initComponents() {
        ...
        setTitle("reorte entre dos fechas");
        ...
        jLabel1.setText("Reporte de contactos entre dos fechas");
...
//MOSTRAR
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (jTextField1.getText().equals("")
            ...
            mr.cargartablacontactosentrefechas(jTable1, jTextField1.getText(), jTextField2.getText());
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        df.show();///muestra el formulario de menuprincipal
...
///aqui se aplica la validacion para que solo acepte numeros
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Dos_fechas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Dos_fechas().setVisible(true);
            }
        });
    }
